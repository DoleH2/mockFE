...
const HomePage = () => {
    ...
    return (
        <div className="container-fluid main-view p-0 background">
            <Navbar />
            {/* main-body */}
            <div className="container frame-main-body">
                <div className="row d-flex align-items-center justify-content-around">
                    <img src={'/img/event/event-show.png'} alt="logo"
                        style={{
                            width: '100%',
                            objectFit: 'cover'
                        }} />
            ...
            <div className="mx-auto frame-slideshow container rounded bg-white mt-4 d-flex justify-content-between p-1" style={{minWidth:'720px',maxWidth:'1000px'}}>
                <Swiper
                    spaceBetween={0}
                    slidesPerView={2}
                    navigation={true}
            ...
            {/* HOT feature product */}
            <div className="frame-featured-product container mt-3 rounded bg-white p-2" style={{minWidth:'720px',maxWidth:'1000px'}}>
            ...
            {/* /HOT feature product */}
            {/* banner sale */}
            <div className='container rounded mt-3 p-0' style={{ overflow: 'hidden',minWidth:'720px',maxWidth:'1000px' }}>
                <img className='w-100' style={{ objectFit: 'cover' }} src={'/img/banner/1200x150-tgdd-1200x150-1.png'}></img>
            </div>
            {/* end banner sale */}
            {/* DT noi bat */}
            <div className='container mt-3 rounded list-phone px-0' style={{ background: '#F8F9FA',minWidth:'720px',maxWidth:'1000px' }}>
