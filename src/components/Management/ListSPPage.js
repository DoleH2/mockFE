...
// import spJSON from '../../json/sanphamJSON.json';
...
const ListSPPage = () => {
    ...
    const options = [
        ...
        { value: 'ram', label: 'RAM' },
        { value: 'nhanHang', label: 'Nhãn Hàng' },
        { value: 'mauSac', label: 'Màu Sắc' },
        { value: 'giaVon', label: 'Giá Vốn' },
        { value: 'giaNiemYet', label: 'Giá Niêm Yết' },
        { value: 'camera', label: 'Camera' },
        { value: 'boNhoTrong', label: 'Bộ Nhớ' }
    ]
    ...
    return (
        <div className="container-fluid p-0 d-flex bg-white">
            {/* menu side */}
            <MenuSide select="listsp"></MenuSide>
            {/* end menu side */}
            {/* content */}
            <div className='frame-view-contents w-100 bg-white p-2' style={{ marginLeft: '300px' }}>
                <div className="frame-content border shadow rounded p-2 mx-auto" style={{ backgroundColor: '#f3f3f3', maxWidth: '1200px', minWidth: '800px' }}>
                    <div className="title-body mb-4">
                        <p className="fs-3 mb-0">Quản Lý Sản Phẩm</p>
                    </div>
                    <div
                    ...
                    >
                        <div
                            ...
                            <p className="h6 m-0 p-2">Danh sách sản phẩm</p>
                        </div>
                        <div className="frame-btn d-flex gap-3 m-2 justify-content-between">
                            <ButtonAdd
                                onClick={() => { changeRouter('/add-sp') }}
                            />
                            {/* frame select search */}
                                            ...
                                            <tr key={idx}>
                                                ...
                                                <td style={{ width: '10%', minWidth: '100px', maxWidth: '150px' }}>
                                                    <div className="d-flex gap-2">
                                                        ...
                                                        <a className="btn btn-light border text-danger border-0" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={() => { handleClickDelete(sp.maSanPham) }}>
                                ...
                                <div className="modal-dialog">
                                    <div className="modal-content">
                                        ...
                                        <div className="modal-body">
                                            <p className='m-0'>
                                                Bạn có muốn xóa Sản Phẩm có Mã là  {accDelete} ?
                                            </p>
